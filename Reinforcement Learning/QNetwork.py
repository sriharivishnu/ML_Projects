...
class DeepQNetwork(object):
    def __init__(self, lr, n_actions, name, fcl_dims=256,input_dims=(210,160,4),chkpt_dir="Reinforcement Learning/tmp"):
        self.lr = lr
        self.name = name
    ...
    def build_network(self):
        with tf.compat.v1.variable_scope(self.name):
            ...
            self.actions = tf.compat.v1.placeholder(tf.float32, shape=[None, self.n_actions], name='action_taken')
...
class Agent(object):
    def __init__(self, alpha, gamma, mem_size, n_actions, epsilon, batch_size, replace_target=5000, input_dims=(210, 160, 4), q_next_dir='Reinforcement Learning/tmp/q_next', q_eval_dir='Reinforcement Learning/tmp/q_eval'):
        self.n_actions = n_actions
